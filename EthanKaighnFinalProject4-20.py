...
while ma1 < 1 or ma1 > 365:        #https://www.adamsmith.haus/python/answers/how-to-use-while-not-in-python
    try:
        ma1 = int(input("What is the first moving average you would like to analyze? (1-360) "))
        if ma1 < 1 or ma1 > 365:
...
while ma2 < 1 or ma2 > 365:
    try:
        ma2 = int(input("What is the second moving average you would like to analyze? (1-360) "))
        if ma2 < 2 or ma2 > 365:
            print("Not a valid moving average ")
    except ValueError:
        print("Not a valid moving average ")
...
while years < 1 or years > 30:
    try:
        years = int(input("How many years would you like to analyze the data for? (1-30) "))
